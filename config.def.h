...
static const Layout layouts[] = {
    ...
    { "=[]",      tile_left },    /* first entry is default */
    { "[]=",      tile_right },
    { "v=",       tile_bottom },
    { "=^",       tile_top },
    { "|[]|",     center },
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_h,      view_shift,     {.i = -1 } },
    { MODKEY|ShiftMask,             XK_l,      view_shift,     {.i = +1 } },
    { MODKEY|ShiftMask,             XK_0,      tag,            {.ui = ~0 } },
    { MODKEY,                       XK_Left,   tag_shift,      {.i = -1 } },
    { MODKEY,                       XK_Right,  tag_shift,      {.i = +1 } },
    { MODKEY|ShiftMask,             XK_Left,   tag_shift_all,  {.i = -1 } },
    { MODKEY|ShiftMask,             XK_Right,  tag_shift_all,  {.i = +1 } },
    { MODKEY|ControlMask,           XK_h,      tag_fshift,     {.i = -1 } },
    { MODKEY|ControlMask,           XK_l,      tag_fshift,     {.i = +1 } },
    { MODKEY|ControlMask,           XK_n,      tag_fshift_all, {.i = -1 } },
    { MODKEY|ControlMask,           XK_period, tag_fshift_all, {.i = +1 } },
